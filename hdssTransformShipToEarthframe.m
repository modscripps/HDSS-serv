...
%% Special case for DP mode (< 0.23 m/s) handled by absolute position,
...
%% testing for the beam correction
Uxx = sonar.uxx + ones(sonar.nbins,1)*sonar.nav;

sonar.Uxx = ones(sonar.nbins,1)*exp(i*(pi/2-Psi)) .* Uxx;
